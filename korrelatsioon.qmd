...
# Jätame veerunimetustes alles vaid enne punkti oleva
names(riigid) %<>% strsplit('\\.') %>% sapply(`[`, 1)
# Kuvame andmetabeli ülevaate
str(riigid)
# Jätame ainult valitud tunnused ja seejärel eemaldame puuduvad väärtused
riigid <- riigid[, 3:17] %>% na.omit
# Arvutame korrelatsioonid
korrelatsioonid <- cor(riigid)
```
