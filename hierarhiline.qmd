...
```{r}
library('magrittr')
wvs <- read.csv('andmed/wvsmap.csv', row.names = 1)
head(wvs)
```
...
Klastrite iseloomustamiseks on palju võimalusi (@sec-kkeskmised). Antud andmete korral võiksime eristada klastreid nö kultuurilisel kaardil.
