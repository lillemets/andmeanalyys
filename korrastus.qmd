...
Andmetabeli ülesehituse küsimisel kuvatakse ka iga tunnuse tüüp, millest sagedasemad on arvtunnus (`num`) ja nimitunnus (`chr`). Täpsemalt loe mõõtmise tasemete ja tunnuse tüüpide kohta peatükist @sec-tunnused või [peatükist -@sec-tunnused].
